...
filenameOriginal <- paste0("data/modeling/runJagsOutDDMDirichlet_original", "_", 
                           toi_original, "_", 
                           time_original, ".rds")

filenameReplication <- paste0("data/modeling/runJagsOutDDMDirichlet_replication", "_", 
                           toi_replication, "_", 
                           time_replication, ".rds")

filenameHDIOriginal <- paste0("data/modeling/hdiDDMDirichlet_original", "_", 
                              toi_original, "_", 
                              time_original, ".rds")

filenameHDIReplication <- paste0("data/modeling/hdiDDMDirichlet_replication", "_", 
                              toi_replication, "_", 
                              time_replication, ".rds")
