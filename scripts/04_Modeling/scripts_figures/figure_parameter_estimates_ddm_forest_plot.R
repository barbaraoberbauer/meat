...
# save plot
filename <- paste0("figures/group_param_estimates_DDM_forest", "_", dataset, "_", translation_of_interest, "_", time, ".pdf")
ggsave(filename, group_param_estimates, width = 12, height = 9)
