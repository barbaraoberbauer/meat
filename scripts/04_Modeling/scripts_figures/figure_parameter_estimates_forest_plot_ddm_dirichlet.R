...
# weight price
mode_w1_base <- distMode(combined_mcmcfin$`mu_w[1]`)
mode_w1_man <- distMode(mu_w_AT_1)
mode_w1_change <- distMode(mu_w_AT_1 - combined_mcmcfin$`mu_w[1]`)

# weight consumption
mode_w2_base <- distMode(combined_mcmcfin$`mu_w[2]`)
mode_w2_man <- distMode(mu_w_AT_2)
mode_w2_change <- distMode(mu_w_AT_2 - combined_mcmcfin$`mu_w[2]`)

# weight popularity
mode_w3_base <- distMode(combined_mcmcfin$`mu_w[3]`)
mode_w3_man <- distMode(mu_w_AT_3)
mode_w3_change <- distMode(mu_w_AT_3 - combined_mcmcfin$`mu_w[3]`)
